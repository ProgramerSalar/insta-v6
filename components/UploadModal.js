        ...
        <div className="">
            ...
            {open && (
                ...
                onRequestClose={() => {setOpen(false);setSelectedFile(null) }}>
                    ...
                    onClick={uploadPost} className="w-full bg-red-600 text-white p-2 shadow-md hover:brightness-125 disabled:bg-gray-200 disabled:cursor-not-allowed disabled:brightness-100">Upload Post </button>
                     </div>
